...
<script type="text/javascript" src="//dadbab.info/content/shared/js/successpage.js"></script>
<script type="text/javascript" src="//dadbab.info/content/shared/js/sp_submit.default.js"></script>
<script type="text/javascript">
    ...
    function onEtag(etag) {
        ...
        img.src = 'https://xl-trk.com/track.gif?' + 'a=pat' + '&b=' + etag +
            '&c=success&d=' + getParameterByName('offer_id');
    }
...
<div class="mod success-page">
    <div class="container">
        <h2 class="success-page__title">Thank you for your order!</h2>
            ...
            <form class="success-page__form" onsubmit="return false;">
                ...
                <div class="success-page__form__container">
                    ...
                    <input type="hidden" name="order_id" value="11771910" class="success-page__form__input">
...
-->
<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id={sub_id7}&ev=Lead&noscript=1" />
